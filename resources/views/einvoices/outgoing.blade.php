@extends('layouts.app')
@section('title', 'Giden E-Faturalar')

@section('content')
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Giden E-Faturalar</h1>
            <p class="text-sm text-gray-500 mt-1">Müşterilere kesilen e-faturaları görüntüleyin</p>
        </div>
        <a href="{{ route('einvoices.create') }}" class="bg-indigo-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-indigo-700">
            <i class="fas fa-plus mr-1"></i> Yeni E-Fatura
        </a>
    </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr>
                        <td colspan="8" class="px-4 py-12 text-center text-gray-400">
                            ...
                            <p class="text-lg">Henüz giden e-fatura bulunmuyor.</p>
                            <p class="text-sm mt-2">
                                <a href="{{ route('einvoices.create') }}" class="text-indigo-600 hover:underline">
                                    <i class="fas fa-plus mr-1"></i>Yeni E-Fatura Oluştur
                                </a>
                            </p>
                        </td>
                    </tr>
