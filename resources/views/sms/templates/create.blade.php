@extends('layouts.app')
@section('title', 'Yeni SMS Şablonu')

@section('content')
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Yeni SMS Şablonu</h1>
        <p class="text-sm text-gray-500 mt-1">Yeni bir SMS mesaj şablonu oluşturun</p>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" x-model="name" @input="generateCode()"
                           value="{{ old('name') }}"
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">Otomatik oluşturulur, isteğe bağlı düzenleyebilirsiniz</p>
                ...
                <div>
                    ...
                    <textarea name="content" id="content" rows="6" x-model="content" x-ref="contentArea"
                              class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                              placeholder="SMS mesaj içeriğini yazın... Değişkenler için sağdaki paneli kullanabilirsiniz."
                              maxlength="918">{{ old('content') }}</textarea>
                    @error('content') <p class="text-xs text-red-500 mt-1">{{ $message }}</p> @enderror

                    {{-- Karakter Sayacı & SMS Parça Bilgisi --}}
