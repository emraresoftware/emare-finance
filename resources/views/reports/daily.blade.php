...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border p-6">
        <form method="GET" class="flex items-end gap-4">
            <div>
                ...
                <input type="date" name="date" value="{{ $date }}" class="rounded-lg border-gray-300 shadow-sm text-sm px-3 py-2 border focus:ring-indigo-500 focus:border-indigo-500">
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border p-5">
            <div class="text-sm text-gray-500">Toplam İskonto</div>
            <div class="text-2xl font-bold text-orange-600 mt-1">₺{{ number_format($summary['total_discount'], 2, ',', '.') }}</div>
        </div>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-sm text-gray-500">{{ $sale->sold_at?->format('H:i') }}</td>
                    </tr>
                    @empty
                    <tr>
